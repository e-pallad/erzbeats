                    ...
                    <Row>
                        <Col xl={{ span: 4 }} md={{ span: 4, order: 1 }} xs={{ span: 12, order: 1 }} className="footer-col social-links">
                            ...
                            <Row className="justify-content-center">
                                <Col xs={{ span: 2 }}>
                                    <a href="https://www.facebook.com/people/Erzbeats-Lichtenberg/100090111153011/" alt="Link zur Facebook Seite von Erzebeats">
                                ...
                                <Col xs={{ span: 2 }}>
                                    <a href="https://www.instagram.com/erzbeats/" alt="Link zur Instagram Seite von Erzebeats">
